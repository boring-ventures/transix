        ...
        <div className="space-y-6">
            ...
            <div className="hidden print:block space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                        <p><strong>Ruta:</strong> {schedule.route?.name}</p>
                        <p><strong>Fecha:</strong> {format(new Date(schedule.departureDate), "PPP", { locale: es })}</p>
                        <p><strong>Bus:</strong> {schedule.bus?.plateNumber || "No asignado"}</p>
                    </div>
                    <div>
                        <p><strong>Estado:</strong> {settlement?.status === "settled" ? "Finalizada" : "Pendiente"}</p>
                        <p><strong>Ingreso Total:</strong> ${formData.totalIncome}</p>
                        <p><strong>Gastos Totales:</strong> ${formData.totalExpenses}</p>
                        <p><strong>Monto Neto:</strong> ${formData.totalIncome - formData.totalExpenses}</p>
                    </div>
                </div>
                    ...
                    <div className="mt-8 pt-8 border-t">
                        <p className="text-center">
                            ...
                            {settlement.settledAt
                                ? format(new Date(settlement.settledAt), "PPP", { locale: es })
                                : "-"}
                        </p>
                    </div>
                )}
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setFormData({
                                            ...formData,
                                            totalIncome: parseFloat(e.target.value),
                                        })
                                    }
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setFormData({
                                            ...formData,
                                            totalExpenses: parseFloat(e.target.value),
                                        })
                                    }
                                    disabled={settlement?.status === "settled"}
                                />
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setFormData({
                                            ...
                                            details: {
                                                ...formData.details,
                                                packages: parseFloat(e.target.value),
                                            },
                                        })
                                    }
                                    disabled={settlement?.status === "settled"}
